...
<Aside type="danger" title="NO INICIAR A TRABAJAR">
Unidad en construcción. Aún no inicies a trabajar en ella.
</Aside>
...
que analizaremos juntos y luego modificaremos para controlarlo desde el micro:bit.
