...
Aquí tienes la rúbrica, ajustada para que evalúe el proceso de las **Actividades 01 a 04** inclusive, excluyendo la Actividad 05 de la evaluación sumativa.

---

### **Rúbrica de Evaluación del Proceso para la Unidad 5: Protocolos de Comunicación Binarios**
...
profesor. El proceso será una conversación corta, 4 minutos, donde tu mismo le dirás al profesor:

1. La nota o valoración que haces de tu proceso en esta unidad.
2. Justificarás, para cada criterio de la rúbrica, tu valoración usando las evidencias en tu bitácora.
</Aside>
